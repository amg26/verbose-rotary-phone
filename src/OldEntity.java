...
public class OldEntity {
    ...
    public OldEntity(Map map, Position pos, double maxspeed , boolean gender, int sightradius, int rank, int health, int thirst, int hunger, double speed) {
        this.pos = pos;
    ...
    public void tick(ArrayList<OldEntity> closeEntities) {
        ...
        ArrayList<OldEntity> kin = new ArrayList<>();
        ArrayList<OldEntity> danger = new ArrayList<>();
        ArrayList<OldEntity> food = new ArrayList<>();
        ...
        /*
            ...
            double min = sightradius;
            OldEntity closestFood = food.get(0);
    ...
    public void consume(OldEntity consumable) {
        OldEntity f = consumable;
        OldEntity w = consumable; //for when there's a river
        //if (this.hunger < 40) {
            if (this.getRank() > f.getRank()) {
                ...
                } else if (f instanceof OldEntity) {
                    this.move(f.getPosition());
    ...
    public void reproduce(OldEntity e){
        if (e.gender){
            e.pregnant = true;
        }
        else if (gender){
    ...
    public void planMove(ArrayList<OldEntity> closeentities){
    ...
    //replace void with ArrayList<OldEntity> vv
    public ArrayList<OldEntity> scan(int sightradius){
        entitiesWithinRadius(sightradius);
        return null;

    }

    public ArrayList<OldEntity> entitiesWithinRadius(int test){
        return null;
    }
